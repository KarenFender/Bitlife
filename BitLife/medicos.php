...
if ($row = mysql_fetch_array($result)){ 
   ...
   do { 
      echo "<tr><td>".$row["CedPro"]."</td><td>".$row["ApPat"]."</td><td>".$row["ApMat"]."</td><td>".$row["Nombre"]."</td><td>".$row["Especialidad"]."</td><td>".$row["Horain"]."</td><td>".$row["horaout"]."</td><form method='post' action='modificarmedico.php'>  <input name=\"cedula\" type=\"hidden\" value=\"$row[CedPro]\">  <td><button class='btn btn-primary'><i class='icon-cog '> </i>Modificar</button></form></td><td><form method='post' action='eliminarmedico.php' name='form'><td> <input name=\"cedula\" type=\"hidden\" value=\"$row[CedPro]\"> <button class='btn btn-danger'><i class='icon-trash '> </i>Eliminar</button></form></td></tr>\n"; 
...
<hr>
          ...
          <button class="btn btn-success"><i class="icon-check-sign "> </i>Agregar Medico</button>
        </form>
