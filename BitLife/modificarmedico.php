...
$query ="select * from doctor where CedPro ='$cedula';";
$res=consulta($query);
$row = mysql_fetch_array($res);
?>

             <form method="post" action="registramedico2.php">
                <legend><h2>Modificar médicos</h2></legend>
                 <div class="prepend">
             ...
             <div class="prepend">
              <td><label for="hora">Especialidad</label></td>
              <span class="add-on"><i class="icon-stethoscope icon-2x"></i></span>
                  <td><select id="especialidad" name="especialidad">
                    ...
                    <option value="Nutriológo">Nutriológo</option>
                        </select></td>
             <div class="prepend">
